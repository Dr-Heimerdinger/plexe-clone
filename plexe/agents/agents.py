...
class PlexeAgent:
    ...
    def __init__(
        ...
        self.orchestrator_model_id = orchestrator_model_id or os.environ.get(
            "PLEXE_ORCHESTRATOR_MODEL", "openai/gpt-oss-20b"
        )
        self.ml_researcher_model_id = ml_researcher_model_id or os.environ.get(
            "PLEXE_ML_RESEARCHER_MODEL", "openai/gpt-oss-20b"
        )
        self.ml_engineer_model_id = ml_engineer_model_id or os.environ.get(
            "PLEXE_ML_ENGINEER_MODEL", "openai/gpt-oss-20b"
        )
        self.ml_ops_engineer_model_id = ml_ops_engineer_model_id or os.environ.get(
            "PLEXE_ML_OPS_ENGINEER_MODEL", "openai/gpt-oss-20b"
        )
        self.tool_model_id = tool_model_id or os.environ.get("PLEXE_TOOL_MODEL", "openai/gpt-oss-20b")
