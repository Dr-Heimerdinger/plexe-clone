...
that use the plexe.relbench.modeling modules for training on relational data.
    ...
    def __init__(
        ...
        self.agent = CodeAgent(
            ...
            description=(
                ...
                "Generates and executes training scripts using plexe.relbench.modeling modules "
