...
model = ModelBuilder(
    provider=ProviderConfig(
        ...
        default_provider="openai/gpt-oss-20b",
        orchestrator_provider="openai/gpt-oss-20b",
        research_provider="openai/gpt-oss-20b",
        engineer_provider="openai/gpt-oss-20b",
        ops_provider="openai/gpt-oss-20b",
        tool_provider="openai/gpt-oss-20b",
    ),
    verbose=False,
)
