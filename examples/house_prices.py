...
model = ModelBuilder(
    provider=ProviderConfig(
        ...
        default_provider="gemini/gemini-2.5-pro",
        orchestrator_provider="gemini/gemini-2.5-pro",
        research_provider="gemini/gemini-2.5-pro",
        engineer_provider="gemini/gemini-2.5-pro",
        ops_provider="gemini/gemini-2.5-pro",
        tool_provider="gemini/gemini-2.5-pro",
    ),
    verbose=False,
)
